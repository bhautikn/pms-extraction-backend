...
1. **Components** — machinery, equipment, assemblies, sub-assemblies
2. **Spare Parts** — individual parts with part numbers, materials, quantities
...
- Figure titles and drawing titles
...
**NEVER generate, invent, infer, or fabricate maintenance tasks** that are not written in the provided document — even if they seem standard for that equipment type.
